...
interface LandingPageProps {
  ...
  onStartJourney: (name: string, institute: string, department: string, targetCompany: string) => void;
...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!trimmed) {
      setError('Please enter your name to personalize your placement journey.');
      return;
    }
    ...
    setTimeout(() => {
      onStartJourney(trimmed, institute, department, selectedTarget);
    }, 400);
  };
              ...
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-700/60">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Personalize your student pass & readiness dashboard</p>
                  </div>
                </div>
                <span className="text-[11px] font-semibold px-2.5 py-1 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20">
                  Step 1 of 1
                </span>
              </div>
