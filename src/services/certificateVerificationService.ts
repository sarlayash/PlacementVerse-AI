...
export function lookupCertificateData(rawCode: string): VerifiedCertificateResult {
  ...
  if (code.startsWith('PV-FINAL') || code.includes('250Q')) {
    ...
    return {
      ...
      endorsedBy: 'Kapil Narula (Program Director, PlacementVerse AI)',
  ...
  if (code.startsWith('PV-TOPIC')) {
    ...
    return {
      ...
      verificationHash: generateVerificationHash(code, studentName),
      verificationUrl,
      benchmark: 'PlacementVerse AI 4-Stage Topic Mastery Standard',
      competencies: [
  ...
  if (code.startsWith('PV-')) {
    return {
      ...
      studentName,
      institute,
      title: 'PlacementVerse Verified Placement Credential',
      type: 'custom',
      issueDate: new Date().toISOString().split('T')[0],
      ...
      verificationHash: generateVerificationHash(code, studentName),
      verificationUrl,
      benchmark: 'PlacementVerse AI Verified Credential',
      competencies: [
